...
namespace COMP003A.FinalProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Last Name
            interpol($"Dagoth: \"Aye, {firstName} is a fine name!\"", interpolSpeed);
            ...
            if (firstName == lastName) { interpol($"Dagoth: \"{firstName} {lastName}? What kinda name is that? Your parents are bloody loons!\" ", interpolSpeed); wait(); } //if last name matches first lol

            //BirthYear & Age
            interpol($"Dagoth: \"Well alright {firstName} {lastName}, I saw you fightin' on the battlefield. A true warrior you are, born to kill.\" ", interpolSpeed); wait();
            interpol("Dagoth: \"It got me wonderin' how old you are.\" ", interpolSpeed); wait();
            do
            {
                birthYear = numberAnswerLoop("Dagoth: \"What year were you born?\"", interpolSpeed);
            } while (!checkBirthYear(birthYear, interpolSpeed));
            age = DateTime.Now.Year - birthYear;

            /* Varied resopnses to age */
            if (age <= 5) { interpol($"Dagoth: \"{age} this year?! You mean to tell me your a toddler? Come off it!\" ", interpolSpeed); wait(); }  //age <=5
            else if (age <= 14 && age > 5)  { interpol($"Dagoth: \"{age} this year?! Your species must age rather quick for that to be true.\" ", interpolSpeed); wait(); } //age <=14
            else if (age <= 19 && age > 14) { interpol($"Dagoth: \"{age} this year? ‘Tis a ripe age for battle!\" ", interpolSpeed); wait(); }  //age <=19
            else if (age <= 39 && age > 19) { interpol($"Dagoth: \"{age} this year? The way you fought, I wouldn't doubt it. A prime age for fightin'.\" ", interpolSpeed); wait(); }   //age <=39
            else if (age <= 69 && age > 39) { interpol($"Dagoth: \"{age} this year?! Aged like a fine wine, you did!\" ", interpolSpeed); wait(); } //age <=69
            else if (age <= 99 && age > 69) { interpol($"Dagoth: \"{age} this year?! I would be a great-grandsire at that age!\" ", interpolSpeed); wait(); }   //age <=99
            else { interpol($"Dagoth: \"{age} this year?! I’m surprised you fight the way you do with brittle for bones.\" ", interpolSpeed); wait(); } //age >99

            //Gender
            interpol("Dagoth: \"And I hope I don’t have to remind you about your gender.\"", interpolSpeed); wait();  
            gender = checkGender(interpolSpeed);

            //Question 1
            Question.Add("What is your species?");
            Answer.Add(wordAnswerLoop("Dagoth: \""+Question[0]+"\" (Species: Ex. Human, Elf, Orc, Giant, etc.)", "Dagoth: \"Never heard o' them before, I think your lyin'.\"", interpolSpeed));
            interpol($"Dagoth: \"Ha! A mirror could tell you as well as I. I could tell you're one o’ them {Answer[0]} peoples just by the look of you.\"", interpolSpeed); wait();
            ...
            interpol($"Dagoth: \"You rarely see one of my peoples have {Answer[1]} hair.\"", interpolSpeed); wait();
            ...
            Answer.Add(wordAnswerLoop("Dagoth: \""+Question[2]+"\" ", "Dagoth: \"No, no that's not it, it was somethin' else.\"", interpolSpeed));
            interpol($"Dagoth: \"{Answer[2]}... I see it now. Wait, now that we are standing eye to eye, it seems that you’re a wee bit taller than me.\"", interpolSpeed); wait();

            //Question 4
            Question.Add("What is your height in inches?");
            height = numberAnswerLoop("Dagoth: \""+Question[3]+"\"", interpolSpeed);
            ...
            weight = numberAnswerLoop("Dagoth: \""+Question[4]+"\"", interpolSpeed);
            ...
            Answer.Add(wordAnswerLoop("Dagoth: \""+Question[5]+"\"", "Dagoth: \"Never heard of that place before, maybe you mispoke.\"", interpolSpeed));
            interpol($"Dagoth: \"{Answer[5]} is many leagues away from this retched place, be thankful for that. Araevell Kingdom is not a place for family and loved ones. \nThe constant battles between the Kreoti Empire and the Shukiar Rebellion have left many without homes to return to.\"", interpolSpeed); wait();

            //Question 7
            Question.Add("How many years have you been fighting this war?");
            fightYears = numberAnswerLoop("Dagoth: \""+Question[6]+"\"", interpolSpeed);
            ...
            { 
                interpol($"Dagoth: \"{fightYears} years?! Came out the womb swingin’ eh? Much like me. I’ve been fightin’ so long that it feels as though I was born with a dirk in my hand. I was born in the slums of this ‘ere kingdom. That’s why I am so passionate about fighting this war. \"", interpolSpeed); wait(); 
            }
            else 
            { 
                interpol($"Dagoth: \"{fightYears} years, eh? I’ve been fightin’ so long that it feels as though I was born with a dirk in my hand. I was born in the slums of this ‘ere kingdom. That’s why I am so passionate about fighting this war.\"", interpolSpeed); wait(); 
            }
            ...
            interpol("Dagoth: \"Let’s find your weapon, it must be lying around here somewhere, what was it again?\"", interpolSpeed); wait();
            Answer.Add(wordAnswerLoop("Dagoth: \""+Question[8]+"\"", "Dagoth: \"No, no that wasn't it. It was something more elegant than that.\"", interpolSpeed));
            interpol($"Dagoth: \"Aha! Here it is, a fine weapon indeed. You musn’t part ways with such a beauty! The finest looking {Answer[8]} I’ve ever laid eyes upon.\"", interpolSpeed); wait();
            interpol($"Dagoth: \"And judging by your weapon, the {Answer[8]}, you must be a... uh... a...\"", interpolSpeed); wait();

            //Question 10
            Question.Add("What is your fighter type?");
            Answer.Add(wordAnswerLoop($"Dagoth: \""+Question[9]+"\" (Fighter Type: Ex. Warlock, Wizard, Warrior, Alchemist, etc.)", "Dagoth: \"Did you come up with that fighting style yourself? Say something I would know.\"", interpolSpeed));
            ...
            {
                //Mainly Dialogue
                interpol("Dagoth: \"The battlefield sounds much quieter from this distance. Here in this temple.\"", interpolSpeed); wait();
                interpol("Dagoth: \"This is the Temple of the Theoí Máchis, ‘The Battle Gods’.\"", interpolSpeed); wait();
                interpol("Dagoth: \"They seek blood sacrifice on the field of battle. Each of these statues: a champion, a warrior, a martyr. They spilled much blood on the battlefield, and now they stand here. Made of stone.\"", interpolSpeed); wait();
                interpol("Dagoth: \"But, When all of your followers believe glory should be had fightin', there won't be many who die of old age.\"", interpolSpeed); wait();
                interpolSame("Dagoth: \"That's why this place is so rundown...", interpolSpeed); Thread.Sleep(750); interpol("abandoned...\"", interpolSpeed); wait();
                interpol("Dagoth: \"Come, we can’t keep that rotten old coot, Commander Uquidor, waiting much longer.\"", interpolSpeed); wait();
            ...
            while (allegiance == "None")
            {
                ...
                if (allegiance == "Neither")
                {
                    ...
                    { 
                        ...
                        interpol("Dagoth: \"Well, which side has been filling your pockets with their coin?\" (Choose a side: Enter [S] or [K] key. {Shukiar Rebellion or Kreoti Empire})", interpolSpeed);
                        switch (Console.ReadKey(true).Key)
                        {
                            case ConsoleKey.S:
